...
public class EstadoHome {
	...
	public Estado findById(java.lang.Integer id) {
		...
		try {
			Estado instance = (Estado) sessionFactory.getCurrentSession().get("dao.Estado", id);
			if (instance == null) {
	...
	public List<Estado> findByExample(Estado instance) {
		...
		try {
			List<Estado> results = (List<Estado>) sessionFactory.getCurrentSession().createCriteria("dao.Estado")
