...
public class AdministradorHome {
	...
	public Administrador findById(int id) {
		...
		try {
			Administrador instance = (Administrador) sessionFactory.getCurrentSession().get("dao.Administrador", id);
			if (instance == null) {
	...
	public List<Administrador> findByExample(Administrador instance) {
		log.debug("finding Administrador instance by example");
		try {
			List<Administrador> results = (List<Administrador>) sessionFactory.getCurrentSession()
					.createCriteria("dao.Administrador").add(create(instance)).list();
