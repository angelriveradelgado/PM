...
public class FormapagoHome {
	...
	public void attachDirty(Formapago instance) {
		log.debug("attaching dirty Formapago instance");
		try {
	...
	public void attachClean(Formapago instance) {
		log.debug("attaching clean Formapago instance");
		try {
	...
	public Formapago findById(java.lang.Integer id) {
		...
		try {
			Formapago instance = (Formapago) sessionFactory.getCurrentSession().get("dao.Formapago", id);
			if (instance == null) {
	...
	public List<Formapago> findByExample(Formapago instance) {
		log.debug("finding Formapago instance by example");
		try {
			List<Formapago> results = (List<Formapago>) sessionFactory.getCurrentSession()
					.createCriteria("dao.Formapago").add(create(instance)).list();
